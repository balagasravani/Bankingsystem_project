...
customerNames = ['Umesh yadav', 'Virat Kohli', 'Lokesh Rahul', 'Axar Patel', 'Ravindra Jadeja']
customerPins = ['0123', '2576', '7279', '2317', '5059']
customerBalances = [20000, 30000, 40000, 50000, 10000]
deposition = 0
withdrawal = 0
balance = 0
counter_1 = 1 # terminated
counter_2 = 5
i = 0
